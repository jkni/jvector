...
public class PQVectors implements CompressedVectors {
    ...
    private final VectorByte<?>[] compressedVectors;
    ...
    public PQVectors(ProductQuantization pq, VectorByte<?>[] compressedVectors)
    {
        this.pq = pq;
    ...
    public static CompressedVectors load(RandomAccessReader in, long offset) throws IOException
    {
        ...
        var compressedVectors = new VectorByte<?>[size];
